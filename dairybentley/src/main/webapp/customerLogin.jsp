...
.form-group {
    flex: 1;
    margin-bottom:20px; /* Change from 0 0 48% to 1 to allow flexible growth */
}
...
<div class="background-image"></div>
    ...
    <div class="main-content">
      ...
      <div class="form-container">
        ...
        <!-- Form action pointing to AdminLoginServlet for actual login validation -->
        <form  action="CustomerLoginServlet" method="post">
            ...
            <p><%= request.getParameter("error") != null ? "Invalid email or password" : "" %>
            <div class="register-link">
            Don't have an account? <a href="CustomerRegistration.jsp">Register here.</a>
        </div>
        </form>
        </div>
    </div>
    ...
    <script>
    function login() {
        // Here you would normally validate the form and send it to the server
        // For this example, we'll just redirect to adminDashboard.jsp
        const email = document.getElementById('email').value.trim();
        const password = document.getElementById('password').value.trim();

        if (email !== "" && password !== "") {
            // Simulate a successful login by redirecting to adminDashboard.jsp
