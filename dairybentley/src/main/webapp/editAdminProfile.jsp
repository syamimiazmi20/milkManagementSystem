...
<body>
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <img src="logoo.jpeg" alt="Logo" class="logo">
        ...
        <a href="milkSalesReport.jsp">Milk Sales Report</a>
    ...
    <div class="form-container">
        ...
        <form action="UpdateAdminProfileServlet" method="post">
            <input type="hidden" name="emp_id" value="<%= employee.getId() %>">
            ...
            <div class="form-group">
                ...
                <input type="tel" id="phone" name="phone" value="<%= phoneNum %>" required>
            </div>
    ...
    <script>
        function discardChanges() {
            window.location.href = 'viewAdminProfile.jsp';
        }
